...
{
    public partial class F_QCM_FrmInspectionResult : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        int page = 0;//记录页数
        public F_QCM_FrmInspectionResult()
        {
            InitializeComponent();
        ...
        public void BindPage1(int pageSize, int pageIndex, out int totalCount)
        {
            ...
            try
            {
                ...
                //this.dataGridView1.Columns["INSPECTION_NO"].Frozen = true;
                //this.dataGridView1.Columns["searchbtn1"].Frozen = true;
                //this.dataGridView1.Columns["printbtn"].Frozen = true;
            }
            catch (Exception ex)
            {
        ...
        private void dataGridView2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                F_QCM_FrmJcReport add = new F_QCM_FrmJcReport(INSPECTION_NO);
                add.ShowDialog();
            }
