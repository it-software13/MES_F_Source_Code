using GDSJ_Framework.WinForm.FormDesign.Control;
using System;
...
namespace GDSJ_Framework.WinForm.FormDesign.FormPanel
{
...
";
                if (!string.IsNullOrEmpty(GDSJ_Framework.Common.WebServiceHelper.GetString(Program.WebServiceUrl, sql, new Dictionary<string, string>())))
                {
                    btnF.Text = "已收藏";
                }
...
";
        ...
        private void Pic_Click(object sender, EventArgs e)
        {
            ...
            GDSJ_Framework.Common.OtherPrograms.RunApp("SJEMS_PictureHelp", "SJEMS_PictureHelp.Interface", "RunApp", OBJ);
        ...
        public void SetData(System.Data.DataRow dr)
        {
            ...
            {
                //for (int i = 2; i <= this.FC.PanelsCount; i++)
                //{
                //    ((FormPanel.BodyPanelClass)this.FC.FormPanels["Panel" + i]).SetHeadData(dr);
                //}
