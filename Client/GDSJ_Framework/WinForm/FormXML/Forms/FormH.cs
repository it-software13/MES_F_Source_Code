...
namespace GDSJ_Framework.WinForm.FormXML.Forms
{
    public partial class FormH : Form
    {
        ...
        public FormH(string XML, string WebServiceUrl,GDSJ_Framework.Class.OrgClass Org)
        {
            InitializeComponent();
        ...
        public FormH(string XML, string WhereSql, string WebServiceUrl, GDSJ_Framework.Class.OrgClass Org)
        {
            InitializeComponent();
