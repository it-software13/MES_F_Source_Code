...
{
    public partial class TQC_Task_Edit_PO : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        private TQC_Task_Edit tqc;
        string art = string.Empty;
        public TQC_Task_Edit_PO(TQC_Task_Edit _tqc,string _art)
        {
            InitializeComponent();
            tqc = _tqc;
            art = _art;
...
Program.SkinThemes, materialSkinManager, this);
        ...
        /// <returns></returns>
        public void GetTQC_Task_Edit_PO(int pageSize, int pageIndex, out int totalCount)
        {
            totalCount = 0;
            try
            {
        ...
        private void TQC_Task_Edit_PO_Load(object sender, EventArgs e)
        {
            pageControl1.BindPageEvent += GetTQC_Task_Edit_PO;
            LoadPage();
