...
{
    public partial class F_QCM_ATR_File3 : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public F_QCM_ATR_File3()
        {
            InitializeComponent();
 ...
 Program.SkinThemes, materialSkinManager, this);
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        dgvr.Cells["报告类型"].Value = dr["TYPE1"].ToString();
        ...
        private void F_QCM_ATR_File3_Load(object sender, EventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                if (this.dataGridView1.Columns[e.ColumnIndex].Name == "operation1")
                {
                    ...
                    if (cell.CurrentItem.Equals("edit"))//编辑
                    {
                        ...
                        F_QCM_ATR_File3_Edit frm = new F_QCM_ATR_File3_Edit(this, dr);
        ...
        {
            F_QCM_ATR_File3_Edit frm = new F_QCM_ATR_File3_Edit(this, null);
            frm.StartPosition = FormStartPosition.CenterParent;
            frm.ShowDialog();
        }
