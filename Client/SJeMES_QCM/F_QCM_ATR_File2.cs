...
{
    public partial class F_QCM_ATR_File2 : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public F_QCM_ATR_File2()
        {
            InitializeComponent();
  ...
  Program.SkinThemes, materialSkinManager, this);
        ...
        {
            F_QCM_ATR_File2_Edit frm = new F_QCM_ATR_File2_Edit(this, null);
        ...
        private void F_QCM_ATR_File2_Load(object sender, EventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                if (this.dataGridView1.Columns[e.ColumnIndex].Name == "operation1")
                {
                    ...
                    if (cell.CurrentItem.Equals("edit"))//编辑
                    {
                        ...
                        F_QCM_ATR_File2_Edit frm = new F_QCM_ATR_File2_Edit(this, dr);
                        frm.StartPosition = FormStartPosition.CenterParent;
                        frm.ShowDialog();
