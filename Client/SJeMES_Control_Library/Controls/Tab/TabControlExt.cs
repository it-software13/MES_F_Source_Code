    ...
    public class TabControlExt : TabControl
    {
        ...
        private void PaintTab(System.Windows.Forms.PaintEventArgs e, int index)
        {
            ...
            if (IsShowCloseBtn)
            {
                ...
                e.Graphics.DrawLine(new Pen(Color.Black,1F), new Point(rect.Right - 15, rect.Top + 5), new Point(rect.Right - 5, rect.Top + 15));
                e.Graphics.DrawLine(new Pen(Color.Black, 1F), new Point(rect.Right - 5, rect.Top + 5), new Point(rect.Right - 15, rect.Top + 15));
            }
        }
        ...
        private void PaintTheSelectedTab(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(new Pen(_headSelectedBackColor,5F), selrect.Left, selrect.Bottom + 1, selrectRight, selrect.Bottom + 1);
        }
