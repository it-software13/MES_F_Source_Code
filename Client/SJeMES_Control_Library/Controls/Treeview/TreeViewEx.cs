...
using SJeMES_Control_Library.Properties;
...
namespace SJeMES_Control_Library.Controls
{
    ...
    public partial class TreeViewEx : TreeView
    {
        ...
        private void TreeViewEx_Click(object sender, TreeViewEventArgs e)
        {
            try
            {
                if (e.Node != null)
        ...
        private void TreeViewEx_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            try
            {
                if (e.Node != null)
                {
                    ...
                    TreeViewEx_AfterSelect(this, new TreeViewEventArgs(e.Node));
                }
            }
            catch (Exception ex)
            {
