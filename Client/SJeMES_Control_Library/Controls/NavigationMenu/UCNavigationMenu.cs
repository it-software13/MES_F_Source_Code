            ...
            if (lbl.Tag != null)
            {
                ...
                if (menu.ParentItem == null)//顶级节点支持图标和角标
                {
                    if (menu.ShowTip)
                    {
                        ...
                        {
                            var rect = new Rectangle(lbl.Width - 40, lbl.Height / 2 - 10, 20, 20);
                        ...
                        {
                            e.Graphics.FillEllipse(new SolidBrush(tipColor), new Rectangle(lbl.Width - 40, lbl.Height / 2 - 15, 10, 10));
                        }
                    }
                    if (menu.Icon != null)
                    {
                        e.Graphics.DrawImage(menu.Icon, new Rectangle(15, (lbl.Height - 25) / 2, 25, 25), 0, 0, menu.Icon.Width, menu.Icon.Height, GraphicsUnit.Pixel);
                    }
                }
