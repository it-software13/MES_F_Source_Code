...
ui_en AS '英语名称',
ui_yn AS '粤语名称'
FROM SJQDMS_UILAN where ui_tittle='all' and ui_cn='" + btnToPage.BtnText.Trim() + "'";
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                        if (value.Language == "en")
                            btnToPage.BtnText = !string.IsNullOrEmpty(dt.Rows[0]["英语名称"].ToString()) ? dt.Rows[0]["英语名称"].ToString() : btnToPage.BtnText;
                        else
                            btnToPage.BtnText = !string.IsNullOrEmpty(dt.Rows[0]["粤语名称"].ToString()) ? dt.Rows[0]["粤语名称"].ToString() : btnToPage.BtnText;
                    }  
                }
        ...
        public UCPagerControl2()
        {
            ...
            txtPage.txtInput.KeyPress += txtPage_KeyPress;
        }
        ...
        public override int PageSize
        {
            ...
            {
                base.PageSize = value;
                if (PageModel == SJeMES_Control_Library.Controls.PageModel.Soure)
                {
                    ResetPageCount();
                    var s = GetCurrentSource();
                    if (ShowSourceChanged != null)
