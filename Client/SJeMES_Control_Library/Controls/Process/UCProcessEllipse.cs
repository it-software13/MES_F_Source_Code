...
namespace SJeMES_Control_Library.Controls
{
    ...
    public partial class UCProcessEllipse : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (m_showType == SJeMES_Control_Library.Controls.ShowType.Ring)
            {
                //中心圆
                ...
                if (m_value > 0 && m_maxValue > 0)
                {
                    ...
                    string strValueText = m_valueType == SJeMES_Control_Library.Controls.ValueType.Percent ? fltPercent.ToString("0%") : m_value.ToString();
