...
namespace SJeMES_Control_Library.Controls
{
    ...
    public class UCProcessLine : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (m_valueTextType == SJeMES_Control_Library.Controls.ValueTextType.Percent)
                strValue = ((float)Value / (float)m_maxValue).ToString("0%");
            else if (m_valueTextType == SJeMES_Control_Library.Controls.ValueTextType.Absolute)
