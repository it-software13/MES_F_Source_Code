...
{
    public partial class UCModuleDateTime : UCModuleControl, IContainerControl
    {
        ...
        { 
            ...
            set
            {
                ...
                if (dateTimePicker1.Text != value.ToString())
                {
        ...
        {
            if(this.Value.ToString() != dateTimePicker1.Text)
                this.Value = dateTimePicker1.Text;
        }
        ...
        public override void InitControl(JSONControlH _ControlConfig)
        {
            ...
            switch (_ControlConfig.control.format)
            {
                case "ymd":
                    this.DataType = ControlDataType.Date;
                    dateTimePicker1.CustomFormat = "yyyy-MM-dd";
                    break;
                case "ymdHms":
                    this.DataType = ControlDataType.DateTime;
                    dateTimePicker1.CustomFormat = "yyyy-MM-dd HH:mm:ss";
                    break;
                case "Hms":
                    this.DataType = ControlDataType.Time;
