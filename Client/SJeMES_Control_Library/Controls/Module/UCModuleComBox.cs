...
{
    public partial class UCModuleComBox : UCModuleControl, IContainerControl
    {
        ...
        { 
            ...
            set
            {
                ...
                if (ucCombox1.SelectedValue != value.ToString())
                {
                    ucCombox1.SelectedValue = value.ToString();
                }
            }
        }
        ...
        {
            if(this.Value.ToString() != ucCombox1.SelectedValue)
            this.Value = ucCombox1.SelectedValue;
        }
        ...
        public override void InitControl(JSONControlH _ControlConfig)
        {
            ...
            this.DataType = ControlDataType.Enum;

            List<KeyValuePair<string, string>> lstcom = new List<KeyValuePair<string, string>>();
            foreach (SJeMES_Framework.Web.JSONEnum e in _ControlConfig.enumData)
            {
                lstcom.Add(new KeyValuePair<string, string>(e.value, e.label));
            }
