...
namespace SJeMES_Control_Library.Controls
{
    ...
    public partial class UCTextBoxEx : UCControlBase
    {
        ...
        /// </summary>
        /// <value><c>true</c> if this instance is show clear BTN; otherwise, <c>false</c>.</value>
        [Description("是否密码输入框"), Category("自定义")]
        public bool IsPassword
        {
            ...
            set
            {
                ...
                {
                    txtInput.PasswordChar = new char();
                }
            }
        }
        ...
        {
            if (keyBoardType == SJeMES_Control_Library.Controls.KeyBoardType.Null)
                return;
            ...
            switch (keyBoardType)
            {
                ...
                case KeyBoardType.UCKeyBorderNum:
                    ...
                    break;
                case SJeMES_Control_Library.Controls.KeyBoardType.UCKeyBorderHand:
