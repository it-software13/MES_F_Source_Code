            ...
            else
            {
                ...
                switch (state)
                {
                    case TipsState.Default:
                        frmTips.pctStat.Image = SJeMES_Control_Library.Properties.Resources.alarm;
                        break;
                    case TipsState.Success:
                        frmTips.pctStat.Image = SJeMES_Control_Library.Properties.Resources.success;
                        break;
                    case TipsState.Info:
                        frmTips.pctStat.Image = SJeMES_Control_Library.Properties.Resources.alarm;
                        break;
                    case TipsState.Warning:
                        frmTips.pctStat.Image = SJeMES_Control_Library.Properties.Resources.warning;
                        break;
                    case TipsState.Error:
                        frmTips.pctStat.Image = SJeMES_Control_Library.Properties.Resources.error;
                        break;
                    default:
                        frmTips.pctStat.Image = SJeMES_Control_Library.Properties.Resources.alarm;
                        break;
