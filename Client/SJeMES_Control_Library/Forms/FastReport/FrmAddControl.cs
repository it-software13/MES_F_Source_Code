...
namespace SJeMES_Control_Library.Forms
{
    public partial class FrmAddControl : Form
    {
        ...
        public FrmAddControl(TextBox txt, GroupBox gb, SJeMES_Framework.Class.ClientClass Client)
        {
            this.txt = txt;
            this.gb = gb;
            this.Client = Client;
        ...
        public FrmAddControl(DateTimePicker dtp, GroupBox gb, SJeMES_Framework.Class.ClientClass Client)
        {
            this.dtp = dtp;
            this.gb = gb;
            this.Client = Client;
        ...
        public FrmAddControl(ComboBox cbo, GroupBox gb, SJeMES_Framework.Class.ClientClass Client)
        {
            this.cbo = cbo;
            this.gb = gb;
            this.Client = Client;
        ...
        public FrmAddControl(GroupBox gb, SJeMES_Framework.Class.ClientClass Client)
        {
            this.gb = gb;
            this.Client = Client;
        ...
        private void SetTitle()
        {
            ...
            if (Client != null)
            {
                tab = Client.GetDataTable(dic[cbo_DataSource.Text]);
            }
            else
            {
