...
{
    public partial class F_BDM_SHOSE_Test_Edit : MaterialForm
    {
        ...
        public F_BDM_SHOSE_Test_Edit(Dictionary<string, object> editInfo)
        {
            InitializeComponent();
            _editInfo = editInfo;
        ...
        private void F_BDM_SHOSE_Test_Edit_Load(object sender, EventArgs e)
        {
            ...
            if (_editInfo != null)
            {
                ...
                cbk_lcll.Checked = string.IsNullOrEmpty(_editInfo["is_lcll"].ToString()) ? false : _editInfo["is_lcll"].ToString() == "1" ? true : false;
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            p.Add("is_lcll", cbk_lcll.Checked?"1":"0");
            if (cmb_judge_type.SelectedValue.ToString()=="2"|| cmb_judge_type.SelectedValue.ToString() == "3")
            {
