...
{
    public partial class F_BDM_DeviceType_Parameter_Item : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public string _id { get; set; }
        public F_BDM_DeviceType_Parameter_Item(string id)
        {
            InitializeComponent();
            _id = id;
        ...
        {
            F_BDM_DeviceType_CP_Item f = new F_BDM_DeviceType_CP_Item("1");
            f.ShowDialog();
            if (f.Tag != null)
            {
