...
{
    public partial class F_BDM_WORKMANSHIP_TESTITEM_Edit : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public Dictionary<string, object> _editInfo = null;
        public List<code_value_OBJ> judge_type = new List<code_value_OBJ>();
        public F_BDM_WORKMANSHIP_TESTITEM_Edit(Dictionary<string, object> editInfo)
        {
            InitializeComponent();
            _editInfo = editInfo;
...
Program.SkinThemes, materialSkinManager, this);
        ...
        private void F_BDM_WORKMANSHIP_TESTITEM_Edit_Load(object sender, EventArgs e)
        {
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            if (value1 == 0)
            {
                MessageBox.Show("Please enter the judgment standard value in the correct format");
                txt_value1.Focus();
                return;
            }
            if (cmb_judge_type.SelectedValue.ToString() == "2" || cmb_judge_type.SelectedValue.ToString() == "3")
            ...
            try
            {
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL,
                         "SJ_BDMAPI", "SJ_BDMAPI.BDM_WORKMANSHIP_TESTITEM", "SaveWORKMANSHIP_TESTITEM", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
