...
{
    public partial class F_BDM_PARTS_TESTITEM_Insert : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public F_BDM_PARTS_TESTITEM_Insert()
        {
            InitializeComponent();
...
Program.SkinThemes, materialSkinManager, this);
        ...
        /// </summary>
        public void GetPARTS_TESTITEM_Custom_Insert()
        {
            try
            {
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(
                                            ...
                                            "GetPARTS_TESTITEM_Custom_Insert",//方法名
        ...
        private void F_BDM_PARTS_TESTITEM_Insert_Load(object sender, EventArgs e)
        {
            GetPARTS_TESTITEM_Custom_Insert();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("The number cannot be empty!");
                return;
            }
            SavePARTS_TESTITEM_Custom_Insert();
        }

        /// <summary>
        /// 保存-检测项目-材料-测试-定制类型
        /// </summary>
        public void SavePARTS_TESTITEM_Custom_Insert()
        {
            try
            {
                Dictionary<string, object> data = new Dictionary<string, object>();
                ...
                //data.Add("parts_code", comboBox1.SelectedValue.ToString());
                //data.Add("parts_name", comboBox1.Text);
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL,
                         "SJ_BDMAPI", "SJ_BDMAPI.BDM_PARTS_TESTITEM", "SavePARTS_TESTITEM_Custom_Insert", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(data));
