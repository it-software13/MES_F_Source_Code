...
{
    public partial class F_BDM_MATERIAL_TESTITEM_Check : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        string cid = string.Empty;
        public F_BDM_MATERIAL_TESTITEM_Check()
        {
            InitializeComponent();
...
Program.SkinThemes, materialSkinManager, this);
        ...
        public F_BDM_MATERIAL_TESTITEM_Check(string _id)
        {
            cid = _id;
            InitializeComponent();
            materialSkinManager = SJeMES_Control_Library.MaterialSkin.MaterialSkinHelper.MaterialSkinManagerSetDefault(
Program.SkinThemes, materialSkinManager, this);
        ...
        /// <summary>
        /// 查询-检测项目-材料-测试-定制类型-勾选
        /// </summary>
        /// <param name="pageSize"></param>
        /// <param name="pageIndex"></param>
        /// <param name="totalCount"></param>
        public void GetMATERIAL_TESTITEM_Custom_Check(int pageSize, int pageIndex, out int totalCount)
        {
            totalCount = 0;
            try
            {
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(
                                            ...
                                            "GetMATERIAL_TESTITEM_Custom_Check",//方法名
        ...
        private void F_BDM_MATERIAL_TESTITEM_Check_Load(object sender, EventArgs e)
        {
            pageControl1.BindPageEvent += GetMATERIAL_TESTITEM_Custom_Check;
            LoadPage();
        ...
        {
            SaveMATERIAL_TESTITEM_Custom_Check();
        }

        /// <summary>
        /// 保存-检测项目-材料-测试-定制类型-勾选
        /// </summary>
        public void SaveMATERIAL_TESTITEM_Custom_Check()
        {
            try
            {
                Dictionary<string, object> data = new Dictionary<string, object>();
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL,
                         "SJ_BDMAPI", "SJ_BDMAPI.BDM_MATERIAL_TESTITEM", "SaveMATERIAL_TESTITEM_Custom_Check", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(data));
