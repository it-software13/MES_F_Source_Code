...
{
    public partial class F_BDM_MATERIAL_TESTITEM_Main : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public List<code_value_OBJ> JudgeList = new List<code_value_OBJ>();
        public F_BDM_MATERIAL_TESTITEM_Main()
        {
            InitializeComponent();
...
Program.SkinThemes, materialSkinManager, this);
        ...
        private void F_BDM_MATERIAL_TESTITEM_Main_Load(object sender, EventArgs e)
        {
            //只要加载一次委托 
        ...
        {
            F_BDM_MATERIAL_TESTITEM_Edit frm = new F_BDM_MATERIAL_TESTITEM_Edit(null);
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            F_BDM_MATERIAL_TESTITEM_Edit frm = new F_BDM_MATERIAL_TESTITEM_Edit(editInfo);
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.ShowDialog();
            if (frm.flag)
            {
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL,
                         "SJ_BDMAPI", "SJ_BDMAPI.BDM_MATERIAL_TESTITEM", "DeleteMATERIAL_TESTITEM", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
        ...
        {
            using (F_BDM_MATERIAL_TESTITEM_Custom f=new F_BDM_MATERIAL_TESTITEM_Custom())
            {
                f.ShowDialog();
            }
        }
