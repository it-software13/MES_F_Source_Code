...
{
    public partial class F_BDM_DeviceType_correction : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        string _id = string.Empty;
        public F_BDM_DeviceType_correction()
        {
            InitializeComponent();
...
Program.SkinThemes, materialSkinManager, this);
        ...
        public F_BDM_DeviceType_correction(string id)
        {
            _id = id;
            InitializeComponent();
            SJeMES_Framework.Common.UIHelper.UIUpdate(this.Name, this, Program.Client, "", Program.Client.Language);
...
Program.SkinThemes, materialSkinManager, this);
        ...
        private void F_BDM_DeviceType_correction_Load(object sender, EventArgs e)
        {
            //只要加载一次委托 
        ...
        {
            F_BDM_DeviceType_correction_Item f = new F_BDM_DeviceType_correction_Item(_id);
            f.ShowDialog();
            pageControl1.PageSize = int.Parse(enum_page.enum_PageSize);
            pageControl1.PageIndex = int.Parse(enum_page.PageIndex);
            pageControl1.SetPage();
