...
{
    public partial class F_BDM_WORKMANSHIP_TESTITEM_Insert : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public F_BDM_WORKMANSHIP_TESTITEM_Insert()
        {
            InitializeComponent();
...
Program.SkinThemes, materialSkinManager, this);
        ...
        /// </summary>
        public void GetWORKMANSHIP_TESTITEM_Custom_Insert()
        {
            try
            {
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(
                                            ...
                                            "GetWORKMANSHIP_TESTITEM_Custom_Insert",//方法名
        ...
        private void F_BDM_WORKMANSHIP_TESTITEM_Insert_Load(object sender, EventArgs e)
        {
            GetWORKMANSHIP_TESTITEM_Custom_Insert();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SaveWORKMANSHIP_TESTITEM_Custom_Insert();
        }

        /// <summary>
        /// 保存-检测项目-工艺-测试-定制类型
        /// </summary>
        public void SaveWORKMANSHIP_TESTITEM_Custom_Insert()
        {
            try
            {
                Dictionary<string, object> data = new Dictionary<string, object>();
                ...
                //data.Add("workmanship_code", comboBox1.SelectedValue.ToString());
                //data.Add("workmanship_name", comboBox1.Text);
                ...
                string retdata = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL,
                         "SJ_BDMAPI", "SJ_BDMAPI.BDM_WORKMANSHIP_TESTITEM", "SaveWORKMANSHIP_TESTITEM_Custom_Insert", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(data));
