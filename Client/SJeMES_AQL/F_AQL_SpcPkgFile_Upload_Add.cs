    ...
    public partial class F_AQL_SpcPkgFile_Upload_Add : MaterialForm
    {
        ...
        private void btn_commit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string tipsMsg = SJeMES_Framework.Common.UIHelper.UImsg("Please upload files！", Program.Client, Program.Client.WebServiceUrl, Program.Client.Language);
