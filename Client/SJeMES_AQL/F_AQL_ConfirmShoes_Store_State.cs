...
{
    public partial class F_AQL_ConfirmShoes_Store_State : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        string aid = string.Empty;
        public F_AQL_ConfirmShoes_Store_State(string _aid)
        {
            InitializeComponent();
            aid = _aid;
...
Program.SkinThemes, materialSkinManager, this);
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        dgvr.Cells["jyr"].Value = dr["jyr"].ToString();
                        dgvr.Cells["ghr"].Value = dr["ghr"].ToString();
                        dgvr.Cells["qrr"].Value = dr["qrr"].ToString();
                        dgvr.Cells["staff_name"].Value = dr["operator"].ToString();
                ...
                SJeMES_Framework.Common.UIHelper.LoadDgv(dataGridView1);
            }
            catch (Exception ex)
            {
                string msg = SJeMES_Framework.Common.UIHelper.UImsg(ex.Message, Program.Client, Program.Client.WebServiceUrl, Program.Client.Language);
        ...
        private void F_AQL_ConfirmShoes_Store_State_Load(object sender, EventArgs e)
        {
