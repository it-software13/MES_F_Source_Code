...
{
    public partial class F_AQL_ShowFrm1 : UserControl
    {
        private Dictionary<string, object> dic_list;
        public F_AQL_ShowFrm1(Dictionary<string, object> _dic_list)
        {
            InitializeComponent();
        ...
        private void GetView()
        {
            try
            {
                ...
                Dictionary<string, object> data = (Dictionary<string, object>)(dic_list.ContainsKey(BotAtype.typekey1) ? dic_list[BotAtype.typekey1] : null);
