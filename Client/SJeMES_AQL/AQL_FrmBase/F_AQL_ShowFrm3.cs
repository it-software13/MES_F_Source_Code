...
{
    public partial class F_AQL_ShowFrm3 : UserControl
    {
        private Dictionary<string, object> dic_list;
        public F_AQL_ShowFrm3(Dictionary<string, object> _dic_list)
        {
            InitializeComponent();
        ...
        private void GetView()
        {
            try
            {
                ...
                Dictionary<string, object> data = (Dictionary<string, object>)(dic_list.ContainsKey(BotAtype.typekey3) ? dic_list[BotAtype.typekey3] : null);
