...
{
    public partial class F_AQL_ShowFrm : UserControl
    {
        private Dictionary<string, object> dic_list;

        public   F_AQL_ShowFrm(Dictionary<string,object> _dic_list)
        {
        ...
        private void GetView()
        {
            try
            {
               ...
               Dictionary<string,object> data = (Dictionary<string, object>)(dic_list.ContainsKey(BotAtype.typekey) ? dic_list[BotAtype.typekey] : null);
