...
namespace SJeMES_Framework.WinForm.FormXML.Forms
{
    public partial class FormHB : Form
    {
        ...
        public FormHB(string XML, string WebServiceUrl,SJeMES_Framework.Class.OrgClass Org)
        {
            InitializeComponent();
        ...
        public FormHB(string XML, string WhereSql, string WebServiceUrl, SJeMES_Framework.Class.OrgClass Org)
        {
            InitializeComponent();
...
";
            ...
            SJeMES_Framework.Common.WebServiceHelper.ExecuteNonQuery(FC.Org, Program.WebServiceUrl, sql, new Dictionary<string, string>());
