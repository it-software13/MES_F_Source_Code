...
{
    public partial class F_IQC_Marketfeedback_Edit2 : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        private string _task_no;
        public F_IQC_Marketfeedback_Edit2(string task_no)
        {
            InitializeComponent();
            _task_no = task_no;
      ...
      Program.SkinThemes, materialSkinManager, this);
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("po number cannot be empty");
                    return;
                }
                ...
                p.Add("size_no", txt_org_name.Text);//码数
                p.Add("return_qty", txt_return_qty.Text);//退货数量
                ...
                p.Add("remark", txt_remark.Text);//问题描述
        ...
        private void F_IQC_Marketfeedback_Edit2_Load(object sender, EventArgs e)
        {
            Getlistxlk();//下拉框
        ...
        private void Getlist()
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    txt_org_name.Text = dt.Rows[0]["factory"].ToString();//工厂
                    txt_production_month.Text = dt.Rows[0]["production_month"].ToString();//新鞋数量
                    txt_return_qty.Text = dt.Rows[0]["return_qty"].ToString();//旧鞋数量
                    ...
                    txt_remark.Text = dt.Rows[0]["remark"].ToString();//备注
                }
